...
<div id="login-page">
    <div class="container">
      ...
      @csrf
        ...
        <input placeholder="Votre nom d'utilisateur" id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
