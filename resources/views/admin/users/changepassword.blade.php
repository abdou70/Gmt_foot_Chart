...
<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="form-panel">
            ...
            @endif
            <form method="POST" action="{{ route('admin.update-pass') }}">
                @csrf
                @method('PUT')
            
                <input hidden id="idclient" name="idclient" type="text" class="form-control" value="{{$user->id}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="password_confirm" name="password_confirm" type="password" class="form-control" required autofocus>
                    </div>
                </div>
